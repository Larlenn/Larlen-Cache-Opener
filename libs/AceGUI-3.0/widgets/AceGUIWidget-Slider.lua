...
local function EditBox_OnEnter(frame)
	frame:SetBackdropBorderColor(1.0, 0.65, 0.0, 0.9)
end

local function EditBox_OnLeave(frame)
	frame:SetBackdropBorderColor(1.0, 0.65, 0.0, 0.45)
end
...
local function Constructor()
	...
	label:SetHeight(15)
	label:SetTextColor(1.0, 0.65, 0.0, 1)
	...
	if thumb then thumb:SetVertexColor(1.0, 0.65, 0.0, 1) end
